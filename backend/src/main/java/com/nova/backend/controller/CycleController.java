...
public class CycleController {
    ...
    public CycleLogResponse createCycleLog(@Valid @RequestBody CycleLogRequest request, Authentication authentication) {
        AuthenticatedUser principal = (AuthenticatedUser) authentication.getPrincipal();
        return cycleService.createLog(principal.userId(), request);
    }
